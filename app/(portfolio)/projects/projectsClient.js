              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 z-10 p-6 md:p-8 lg:p-10">
                  ...
                  <div className="mt-5 overflow-hidden">
                    <p className="max-w-2xl translate-y-3 text-sm leading-7 text-white/50 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100 md:text-base">
                      {project.description}
                    </p>
                  </div>
